 ...
 * @author moise
 */
public record PantieResponseDTO(Integer id, String color, Integer quantity, Double price,
    String fabric, String brand, String style,
    Gender gender, String pattern, ClothingType clothingType,
    Character size, LiningType liningType, WaistType waistType, SideType sideType) implements ClothingResponseDTO {
}
